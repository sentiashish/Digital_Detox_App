...
- Focus session duration and completion history
- Streak counts and usage summaries
...
- Overlay permission: used to show the blocking experience on top of distracting apps.
...
Publish this policy on a public page, such as GitHub Pages, before Play Store submission.
